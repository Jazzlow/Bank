...
class DepositsControllerTest < ActionController::TestCase
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post :create, deposit: { amount: @deposit.amount, description: @deposit.description, name: @deposit.name }
    end
  ...
  test "should update deposit" do
    patch :update, id: @deposit, deposit: { amount: @deposit.amount, description: @deposit.description, name: @deposit.name }
    assert_redirected_to deposit_path(assigns(:deposit))
  end
