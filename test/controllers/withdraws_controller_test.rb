...
class WithdrawsControllerTest < ActionController::TestCase
  ...
  test "should create withdraw" do
    assert_difference('Withdraw.count') do
      post :create, withdraw: { amount: @withdraw.amount, description: @withdraw.description, name: @withdraw.name }
    end
  ...
  test "should update withdraw" do
    patch :update, id: @withdraw, withdraw: { amount: @withdraw.amount, description: @withdraw.description, name: @withdraw.name }
    assert_redirected_to withdraw_path(assigns(:withdraw))
  end
